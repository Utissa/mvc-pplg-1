   ...
   <div class="container">
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
           <div class="container-fluid">
               ...
               <ul class="navbar-nav">
    <li class="nav-item">
        <a href="controller_pasien.php" class="nav-link">Pasien</a>
    </li>
    <li class="nav-item">
        <a href="controller_dokter.php" class="nav-link">Dokter</a>
    </li>
    <li class="nav-item">
        <a href="controller_kunjungan.php" class="nav-link">Kunjungan</a>
    </li>
</ul>
    ...
    <a href="hapuspasien.php?id=<?= $data['idPasien']; ?>" class="btn btn-danger btn-sm">Hapus</a>
</td>
